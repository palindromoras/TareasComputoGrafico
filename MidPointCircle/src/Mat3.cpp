...
Mat3& Mat3::Rotar(const float& RotarAnguloZ) {
	Mat3 Matriz;
	Matriz.a[0][0] = cos(RotarAnguloZ*3.1416 / 180.0);
	Matriz.a[0][1] = -sin(RotarAnguloZ*3.1416 / 180.0);
	Matriz.a[0][2] = 0;
	Matriz.a[1][0] = sin(RotarAnguloZ*3.1416 / 180.0);
	Matriz.a[1][1] = cos(RotarAnguloZ*3.1416 / 180.0);
	Matriz.a[1][2] = 0;
	Matriz.a[2][0] = 0;
	Matriz.a[2][1] = 0;
	Matriz.a[2][2] = 1;
